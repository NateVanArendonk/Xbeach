% Extract transect from asc file
% Extracts all transects in kml and saves as matlab files
clearvars

% Load bathy (takes 2-3 minutes)
tic
B = ascii2xyz('nkmos1.asc');
toc

% Load kml
T = kml2struct('XB_Transects.kml');
